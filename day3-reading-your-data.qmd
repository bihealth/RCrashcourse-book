...
### Using colorDF to diagnose datasets {#sec-colorDF}

[`colorDF`,`summary_colorDF()`]{.aside}
...
::: {.callout-caution icon=false appearance="simple"}
::: {#exr-metadata_botched-2}
## Correcting metadata

In @exr-diagnosing, you have diagnosed the file
